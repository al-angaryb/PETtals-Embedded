...
#include <string.h>
#include <inttypes.h>
#include "M6E_API/include/tm_reader.h"
...
#define usage()                                                                                 \
    {                                                                                           \
        errx(1, "Please provide valid reader URL, such as: reader-uri [--ant n]\n"              \
...
int main(int argc, char *argv[])
{
    ...
    /* Read Plan */
    {
        ...
        /* Embedded Tagop */
        {
            ...
            if ((0 == strcmp("M6e", model.value)) || (0 == strcmp("M6e PRC", model.value)) || (0 == strcmp("M6e Micro", model.value)) || (0 == strcmp("Mercury6", model.value)) || (0 == strcmp("Astra-EX", model.value)) || (0 == strcmp("M6e JIC", model.value)) || (0 == strcmp("Sargas", model.value)) || (0 == strcmp("Izar", model.value)))
            {
                /**
